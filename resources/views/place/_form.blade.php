...
<section class="grid grid-cols-1 xl:gap-4 mt-4 xl:grid-cols-3 bg-white p-6 rounded">
    <div class="col-span-2">
        ...
        <div class="mb-5">
            ...
            {{ html()->text('place_kitchen')->class('form-control ' . ($errors->has('place_kitchen') ? 'border border-red-500' : '')) }}
            {{-- error --}}
        ...
        <--- <div class="mb-5">
            ...
            {{ html()->text('place_service')->class('form-control ' . ($errors->has('place_service') ? 'border border-red-500' : '')) }}
            {{-- error --}}
